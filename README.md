...
|10 (4/6)|<li>Glyphs Demo: Using smart lists (for ASCII set)</li><li>Lecture: Typeface Specimens</li><li>(individual groups) Typeface Critique & Feedback</li>|<li>Complete template proof with the required character set, spacing strings, and sample text ([link](https://github.com/spacetypeco/TypeDesignSP22/tree/main/templates/Week10))</li><li>Upload proof to [class drive](https://drive.google.com/drive/folders/1DodSPJE6B6-4IOmi0jZx5Xw820LC0BR9?usp=sharing)</li>
|11 (4/13)|<li>(small group) typeface critique & feedback</li>|<li>Complete template proof with the required character set, spacing strings, and sample text ([link](https://github.com/spacetypeco/TypeDesignSP22/tree/main/templates/Week11))</li><li>Upload proof to [class drive](https://drive.google.com/drive/folders/1lY_BEIoe9i82t0DbqdKD3MBKM7VU1DR7?usp=sharing)</li>
|12 (4/20)|<li>(small group) Typeface Critique & Feedback</li>| <li>Complete template proof with the required character set, spacing strings, sample text [(link)](https://github.com/spacetypeco/TypeDesignSP22/tree/main/templates/Week12)</li><li>Watch Type Specimen Lecture Video (link was shared via class email) and make in-progress draft of type specimen</li><li>Upload specimen and proof to [class drive](https://drive.google.com/drive/folders/1ycr9BphFlPb9ZSBL3cxBlfz9nW2ts15-?usp=sharing)</li>
|13 (4/27)|<li>(format TBD) Typeface Critique & Feedback</li>|<li>Complete template proof</li><li>In-Progress draft of type specimen (minimum 3 slides/pages that include: character set, design/feature highlights, in-use mockups)</li>
