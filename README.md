...
|2 (2/2)|<li>Discussion: Reading</li><li> Lecture: Introduction to Type Design & Review of basic terminology</li><li>Demo: Carolingian Calligraphy</li><li>Demo: Sketching Letterforms</li><li>Demo: Overview of Glyphs App (Part 1)</li>| <li>Theory of Type Design: Chapters 5–6 </li> <li>3 best pages of calligraphy practice (upload to [class drive](https://drive.google.com/drive/folders/1dIXWXGrrwisDnFMsdMm_wYISy8-oIpfI?usp=sharing)) </li> <li>Digitize Carolingian 'test word' character set (upload to [class drive](https://drive.google.com/drive/folders/1dIXWXGrrwisDnFMsdMm_wYISy8-oIpfI?usp=sharing))</li>
