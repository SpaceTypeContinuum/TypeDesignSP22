...
|4 (2/16)|<li>Discussion: Reading</li><li>Sketching a test word using Translation/Expansion model technique & TypeCooker recipes</li><li>Lecture: Proofing Demo</li><li>**Assignment 2 OUT**: Making a Variable Font</li>|<li>Theory of Type Design: Chapters 13-15</li><li>upload a favorite [TypeCooker](https://typecooker.com/?level=1) sketch to google drive using test word 'noise' (& add recipe!)</li><li>digitize test word letters in Glyphs</li>
