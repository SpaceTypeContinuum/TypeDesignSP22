...
|6 (3/2)|<li>**Final Assignment OUT**</li><li>Lecture:Typefaces for Today</li><li>Demo: Glyphs App Efficiency (Plotting Vectors, Layers, Components, Using spacing Strings)</li>|<li>Theory of Type Design: Chapters 17–20</li><li>3 Typeface Proposal Drafts (that includes sketches of test words)</li>
